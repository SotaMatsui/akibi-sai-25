...
function AccessSection({ className, id }: { className?: string; id?: string }) {
  ...
  return (
    <div className="w-full" ref={scope}>
      <div
        className={`gsap-horizontal-trigger min-h-screen flex min-w-0 overflow-x-hidden w-full ${className}`}
        id={id}
      >
        <div className="gsap-horizontal flex items-center justify-center gap-16 w-full">
          <iframe
            ...
            loading="lazy"
            className="w-full max-w-2xl aspect-[4/3] border-0 rounded-3xl mt-8 z-10"
          ></iframe>
          <div
          ...
          <div className="w-0 min-w-0 flex flex-col items-start justify-center">
            <h2 className="text-center text-nowrap font-serif py-4 md:text-2xl xl:text-5xl">
              秋田公立美術大学
            </h2>
            <div className="text-left text-nowrap font-semibold text-lg max-w-md space-y-2">
